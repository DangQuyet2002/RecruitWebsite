var CONTENTEDIT = (function () {
    ...
    function init() {
        ...
        $('#frmBannerSave').validate().settings.ignore = ":hidden:not(.wysiwygeditor), .ck-editor__editable";
    }
    ...
    function bindSave() {
        debugger
        $('#frmBannerSave').on('click', '#btnSave', function (e) {
            e.preventDefault();
            ...
            var txtArea = form.find(selectors.Description);
            ...
            if (valid) {
                ...
                if (selectors.Description.val().length === 0 || selectors.Description.val() === templateEmpty) {
