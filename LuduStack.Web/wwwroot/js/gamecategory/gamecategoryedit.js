var GAMEEDIT = (function () {
    ...
    function cacheObjects() {
        objs.container = $('#frmCategorySave');
    ...
    function bindSave() {
        $('#frmCategorySave').on('click', '#btnCategorySave', function (e) {
            e.preventDefault();
