...
namespace LuduStack.Infra.Data.MongoDb.Repository
{
    public class GameRepository : BaseRepository<Game>, IGameRepository
    {
        ...
        public async Task<bool> AddComment(GameComment model)
        {
            FilterDefinition<Game> filter = Builders<Game>.Filter.Where(x => x.Id == model.UserGameId);
            UpdateDefinition<Game> add = Builders<Game>.Update.AddToSet(c => c.Comments, model);
